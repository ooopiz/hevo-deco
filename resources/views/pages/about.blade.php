...
<div class="brand-story container">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <p>百鐵認真把關流程並且希望<br>在收到產品時也能感受到師傅們的熱情, 在包裝內都會附張<b>沾上指紋的”黑手認證”貼紙</b>, 表示從設計到製作以及包裝每一道程序都<br>充滿手感與專業。
            </p>
        </div>
        <div class="col-md-4 col-md-offset-2">
...
<script>
    ...
    document.getElementById('nav-small-4').style.borderBottom = "0.4rem solid #b0bec5";
</script>
